...
internal static class ExceptionPolyfillsBuilder
{
    ...
    private static void GenerateArgumentNullException(
    ...
    private static void GenerateArgumentException(
        StringBuilder builder,
        TargetFramework targetFramework
    )
    {
    ...
    private static void GenerateObjectDisposedException(
        StringBuilder builder,
        TargetFramework targetFramework
    )
    {
    ...
    private static void GenerateArgumentOutOfRangeException(
        StringBuilder builder,
        TargetFramework targetFramework
    )
    {
    ...
    private static void GenerateNumericMethods(
        StringBuilder builder,
        TargetFramework targetFramework
    )
    {
    ...
    private static void GeneratePrimitiveTypeOverloads(StringBuilder builder)
    {
        ...
        {
            string clsCompliantAttribute = isClsCompliant
                ? ""
                : "[global::System.CLSCompliant(false)]";
